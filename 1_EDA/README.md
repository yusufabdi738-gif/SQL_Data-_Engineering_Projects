...
2. [`02_top_paying_skils.sql`](./02_top_paying_skils.sql) - salary analysis with aggregations
...
- n🛠️ **Development**: VS Code for SQL editing + Terminal for DuckDB CLI
- 📦 **Version Control**: Git/GitHub for versioned SQL scripts
## Analysis Overview

### Query Structure
1. [Top Demanded Skills](./01_top_demanded_skills.sql) – dentifies the 10 most in-demand skills for remote data engineer positions
2. [Top Paying Skills](./02_top_paying_skils.sql) - Analyzes the 25 highest-paying skills with salary and demand metrics
